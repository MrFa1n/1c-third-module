        ...
        <div class="posts col-8">
            ...
            <div class="row add-post">
                <form action="create.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col">
                        <input name="title" class="form-control form-control-lg" id="floatingInputValue" placeholder="Заголовок">
                    </div>
                    <div class="form-floating">
                        <textarea name="content" class="form-control" placeholder="Leave a comment here" id="editor" style="height:100px"></textarea>
                    </div>
                    ...
                    <div class="col-auto">
                        ...
                        <input type="checkbox" name="publish" value="1" id="">
                    </div>
                    <div class="col-auto">
